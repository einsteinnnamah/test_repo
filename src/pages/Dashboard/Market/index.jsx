...
import CompleteRegistrationPop from "components/CompleteRegistration";
const MarketDashboard = () => {
  ...
  return (
    <div className="pd_market_dashboard pd_market_page">
      <PageDescription
        title={"Currency Backed Securities"}
        description={
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt u"
        }
        date={"Data as at 10th January 2021, 10:00AM"}
      />
      <CompleteRegistrationPop />
      <SupportBtn />
